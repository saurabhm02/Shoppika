...
//         console.log('Before adding to cart:', item);
    
//         // Add the item to the cart
//         const cartDocRef = await addDoc(cartCollectionRef, { ...item, quantity: 1 });
//         dispatch(addToCart({ ...item, oneQuantityPrice: item.price, docId: cartDocRef.id }));
    
//         console.log('After adding to cart:', item);
    
//         // Remove the item from the wishlist
//         const wishlistDocRef = await doc(wishlistCollectionRef, item.id);
//         await deleteDoc(wishlistDocRef);
//         dispatch(removeFromWishlist({ id: item.id }));
    
//         console.log('After removing from wishlist:', item);
    
//         toast.success(`${item.title} is moved to cart!`, {
